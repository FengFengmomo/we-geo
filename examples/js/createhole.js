...
function createSphereWithHoles( arg1, arg2 ) {
	...
	if( typeof arg1 === 'number' ) { // variant detail, holes are optional, radius = 1 is fixed - use three.js .scale
...
export {createSphereWithHoles, buildSphereWithHolesObj, buildSphereWithHoles};